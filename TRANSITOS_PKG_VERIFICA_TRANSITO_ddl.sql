...
/* Formatted on 23/03/2017 12:27:50 (QP5 v5.126) */
IS
    -- Etapas del transito
    ...
    BEGIN
        ...
        /*      IF (keycuo IN
                        ('721',
                         ...
                         '072'))
        */
        IF (   SUBSTR (keycuo, 2, 1) = '4'
            OR SUBSTR (keycuo, 2, 1) = '2'
            OR keycuo IN ('071', '072'))
        THEN
            ...
            cantidad :=
                ops$asy.f_verif_ds2295 (v_key_cuo,
                                        v_key_voy_nber,
                                        v_key_dep_date,
                                        'TRANSITO');
        --*********
             ...
             WHERE       a.key_cuo = c.key_cuo
                     ...
                     AND g.carbol_frt_prep NOT IN
                                ('737',
                                 ...
                                 '232',
                                 '332',
                                 '931'); --2.  El Sistema no debera permitir el inicio de tr?nsito hacia una administraci?n de zona franca comercial, a excepci?n de zona franca Cobija.
    ...
    BEGIN
        ...
        THEN
            SELECT   COUNT (1)
              INTO   cantidad
              FROM   unetitab a
             WHERE   a.key_cuo = keycuo AND a.lst_ope = 'U';
